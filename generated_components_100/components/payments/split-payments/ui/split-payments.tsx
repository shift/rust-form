...
interface splitpaymentsProps {
  className?: string;
  onAction?: (data: any) => void;
  config?: Record<string, any>;
}

export const splitpayments: React.FC<splitpaymentsProps> = ({ 
  className = 'split-payments', 
  onAction,
  config = {}
}) => {
  ...
  useEffect(() => {
    console.log('Component split-payments initialized');
  }, []);
      ...
      <div className={"${className}__content"}>
        {loading ? (
          ...
          <div className={"${className}__main"}>
            <p>Component content for split-payments</p>
