...
interface achpaymentsProps {
  className?: string;
  onAction?: (data: any) => void;
  config?: Record<string, any>;
}

export const achpayments: React.FC<achpaymentsProps> = ({ 
  className = 'ach-payments', 
  onAction,
  config = {}
}) => {
  ...
  useEffect(() => {
    console.log('Component ach-payments initialized');
  }, []);
      ...
      <div className={"${className}__content"}>
        {loading ? (
          ...
          <div className={"${className}__main"}>
            <p>Component content for ach-payments</p>
