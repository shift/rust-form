...
export const affiliatetracking: React.FC<affiliatetrackingProps> = ({ 
  ...
  useEffect(() => {
    console.log('Component affiliate-tracking initialized');
  }, []);
      ...
      <div className={"${className}__content"}>
        {loading ? (
          ...
          <div className={"${className}__main"}>
            <p>Component content for affiliate-tracking</p>
