...
export const bulkorders: React.FC<bulkordersProps> = ({ 
  className = 'bulk-orders', 
  onAction,
  config = {}
}) => {
  ...
  useEffect(() => {
    console.log('Component bulk-orders initialized');
  }, []);
      ...
      <div className={"${className}__content"}>
        {loading ? (
          ...
          <div className={"${className}__main"}>
            <p>Component content for bulk-orders</p>
