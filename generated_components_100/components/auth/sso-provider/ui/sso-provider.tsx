...
export const ssoprovider: React.FC<ssoproviderProps> = ({ 
  className = 'sso-provider', 
  onAction,
  config = {}
}) => {
  ...
  useEffect(() => {
    console.log('Component sso-provider initialized');
  }, []);
      ...
      <div className={"${className}__content"}>
        {loading ? (
          ...
          <div className={"${className}__main"}>
            <p>Component content for sso-provider</p>
