...
interface captchaintegrationProps {
  className?: string;
  onAction?: (data: any) => void;
  config?: Record<string, any>;
}

export const captchaintegration: React.FC<captchaintegrationProps> = ({ 
  className = 'captcha-integration', 
  onAction,
  config = {}
}) => {
  ...
  useEffect(() => {
    console.log('Component captcha-integration initialized');
  }, []);
      ...
      <div className={"${className}__content"}>
        {loading ? (
          ...
          <div className={"${className}__main"}>
            <p>Component content for captcha-integration</p>
